...
export default async function LoginPage({
  ...
  return (
    <div className="flex min-h-screen flex-col lg:flex-row">
      {/* 좌측 브랜드 히어로 */}
      <div
        className="relative hidden overflow-hidden lg:flex lg:w-[52%] lg:flex-col lg:justify-between"
      ...
      >
        ...
        <div className="relative grid grid-cols-2 gap-px bg-white/15 px-px pb-px">
          {STEPS.map((s) => (
            <div key={s.n} className="px-14 py-5" style={{ background: "rgba(255,255,255,0.06)" }}>
